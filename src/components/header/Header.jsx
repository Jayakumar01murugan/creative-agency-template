    ...
    <header className='header-section'>
      <Slide>
        <div className="each-slide-effect">
          <div className='slide1' style={{ 'backgroundImage': `url(${slider1})` }}>
        ...
        <div className="each-slide-effect">
          <div className='slide2' style={{ 'backgroundImage': `url(${slider2})` }}>
            <div className='slide-container'>
        ...
        <div className="each-slide-effect">
          <div className='slide3' style={{ 'backgroundImage': `url(${slider3})` }}>
            <div className='slide-container'>
